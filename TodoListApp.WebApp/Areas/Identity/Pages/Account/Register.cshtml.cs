...
namespace TodoListApp.WebApp.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<TodoListAppWebAppUser> _signInManager;
        private readonly UserManager<TodoListAppWebAppUser> _userManager;
        private readonly IUserStore<TodoListAppWebAppUser> _userStore;
        private readonly IUserEmailStore<TodoListAppWebAppUser> _emailStore;
        ...
        private IUserEmailStore<TodoListAppWebAppUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<TodoListAppWebAppUser>)_userStore;
        }
    }
}

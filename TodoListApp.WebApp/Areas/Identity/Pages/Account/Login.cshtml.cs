...
namespace TodoListApp.WebApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<TodoListAppWebAppUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                var result = await this.signInManager.PasswordSignInAsync(this.Input.Email, this.Input.Password, Input.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
